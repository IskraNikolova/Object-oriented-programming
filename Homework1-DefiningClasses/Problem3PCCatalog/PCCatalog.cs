namespace Problem3PCCatalog
{
    ...
    public class PcCatalog
    {
        public static void Main()
        {
            ...
            Component components3 = new Component(graphicsCard, graphicsCardDetails, priceGraphicsCard);
            ...
            Component componentsSecond2 = new Component(processor2, detailsProcessor, priceProcessor2);
