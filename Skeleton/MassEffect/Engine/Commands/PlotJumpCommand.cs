...
namespace MassEffect.Engine.Commands
{
    ...
    public class PlotJumpCommand : Command
    {
        ...
        public override void Execute(string[] commandArgs)
        {
            ...
            var ship = base.GetStarship(shipName);

            base.ValidateAlive(ship);

            var previousLocation = ship.Location;
            var starSystemDestination = this.GameEngine.Galaxy.GetStarSystemByName(destinationName);
            ...
            this.GameEngine.Galaxy.TravelTo(ship, starSystemDestination);
